namespace CodeStage.AdvancedFPSCounter.CountersData
{
	...
	public class FPSCounterData: UpdatableCounterData
	{
        ...
        private const string SensorFpsTextStart = ColorTextStart + "SNS: ";
        ...
        private string sensorFpsCached;
        ...
        [Tooltip("Shows sensor fps.")]
        [SerializeField]
        private bool sensorFps;
        public float sensorFpsValue = 0f;
		...
		internal override void UpdateValue(bool force)
		{
			...
			if (dirty && main.OperationMode == OperationMode.Normal)
			{
                ...
                if (sensorFps)
                {
                    ...
                    text.Append(sensorFpsCached).
                         AppendLookup((int)sensorFpsValue).Append(" FPS").
                         Append(ColorTextEnd);
                }
		...
		protected override void CacheCurrentColor()
		{
            ...
            sensorFpsCached = string.Format(SensorFpsTextStart, colorRenderString);
        }
