...
public class ES2Web
{
	...
	private void CheckWWWUsage()
	{
		...
		if(www != null && !www.isDone)
			Debug.LogError("This ES2Web object is already being used. Please create a new ES2Web object to perform this upload.");
	}
	
	private void CheckDownloadUsage()
	{
		if(data.Length == 0)
			Debug.LogError("No data to load from. Please ensure that you use Download() before calling ES2.Load methods, and that an error didn't occur while downloading.");
	}
