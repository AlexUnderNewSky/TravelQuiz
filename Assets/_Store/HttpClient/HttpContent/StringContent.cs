...
namespace CI.HttpClient
{
    public class StringContent : IHttpContent
    {
        ...
        //public StringContent(string content, Encoding encoding, string mediaType, bool includeCharset)
        //{
        //    _content = encoding.GetBytes(content);
        ...
        //public StringContent(string content, Encoding encoding, string mediaType, string headerKey, string headerVal)
        //{
        //    _content = encoding.GetBytes(content);
